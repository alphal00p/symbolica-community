...
class CompiledComplexEvaluator:
    ...
    def load(cls, filename: builtins.str, function_name: builtins.str, input_len: builtins.int, output_len: builtins.int) -> CompiledComplexEvaluator:
        ...
        """
    def evaluate(self, inputs: numpy.typing.ArrayLike) -> numpy.typing.NDArray[numpy.complex128]:
        r"""
...
class CompiledCudaComplexEvaluator:
    ...
    """
    @classmethod
    def load(cls, filename: builtins.str, function_name: builtins.str, input_len: builtins.int, output_len: builtins.int, number_of_evaluations: builtins.int, block_size: builtins.int = ...) -> CompiledCudaComplexEvaluator:
        r"""
        Load a compiled library, previously generated with `compile`.
        """
    def evaluate(self, inputs: numpy.typing.ArrayLike) -> numpy.typing.NDArray[numpy.complex128]:
...
class CompiledCudaRealEvaluator:
    ...
    """
    @classmethod
    def load(cls, filename: builtins.str, function_name: builtins.str, input_len: builtins.int, output_len: builtins.int, number_of_evaluations: builtins.int, block_size: builtins.int = ...) -> CompiledCudaRealEvaluator:
        r"""
        Load a compiled library, previously generated with `compile`.
        """
...
class CompiledSimdComplexEvaluator:
    ...
    """
    @classmethod
    def load(cls, filename: builtins.str, function_name: builtins.str, input_len: builtins.int, output_len: builtins.int) -> CompiledSimdComplexEvaluator:
        r"""
        Load a compiled library, previously generated with `compile`.
        """
    def evaluate(self, inputs: numpy.typing.ArrayLike) -> numpy.typing.NDArray[numpy.complex128]:
...
class CompiledSimdRealEvaluator:
    ...
    """
    @classmethod
    def load(cls, filename: builtins.str, function_name: builtins.str, input_len: builtins.int, output_len: builtins.int) -> CompiledSimdRealEvaluator:
        r"""
        Load a compiled library, previously generated with `compile`.
        """
    def evaluate(self, inputs: numpy.typing.ArrayLike) -> numpy.typing.NDArray[numpy.float64]:
...
class Evaluator:
    ...
    @typing.overload
    @classmethod
    def compile(cls, function_name: builtins.str, filename: builtins.str, library_name: builtins.str, number_type: typing.Literal['real_4x'], inline_asm: builtins.str = "default", optimization_level: typing.Optional[builtins.int] = 3, compiler_path: typing.Optional[builtins.str] = None, compiler_flags: typing.Optional[typing.Sequence[builtins.str]] = None, custom_header: typing.Optional[builtins.str] = None) -> CompiledSimdRealEvaluator:
        r"""
        Compile the evaluator to a shared library using C++ and optionally inline assembly and load it.
    ...
    @typing.overload
    @classmethod
    def compile(cls, function_name: builtins.str, filename: builtins.str, library_name: builtins.str, number_type: typing.Literal['complex_4x'], inline_asm: builtins.str = "default", optimization_level: typing.Optional[builtins.int] = 3, compiler_path: typing.Optional[builtins.str] = None, compiler_flags: typing.Optional[typing.Sequence[builtins.str]] = None, custom_header: typing.Optional[builtins.str] = None) -> CompiledSimdComplexEvaluator:
        r"""
        Compile the evaluator to a shared library using C++ and optionally inline assembly and load it.
    ...
    def evaluate(self, inputs: numpy.typing.ArrayLike) -> numpy.typing.NDArray[numpy.float64]:
        ...
        """
    def evaluate_complex(self, inputs: numpy.typing.ArrayLike) -> numpy.typing.NDArray[numpy.complex128]:
        r"""
        Evaluate the expression for multiple inputs that are flattened and return the flattened result.
...
class Expression:
    ...
    """
    @typing.overload
    def __call__(self, *args: Expression | int | str | float | builtins.complex) -> Expression:
        r"""
        ...
        """
    @typing.overload
    def __call__(self, *args: HeldExpression | Expression | int | str | float | builtins.complex) -> HeldExpression:
        r"""
    ...
    def to_polynomial(self, vars: typing.Optional[typing.Sequence[Expression]] = None) -> Polynomial:
        ...
        """
    @typing.overload
    def to_polynomial(self, minimal_poly: Polynomial, vars: typing.Optional[typing.Sequence[Expression]] = None) -> NumberFieldPolynomial:
        r"""
        ...
        """
    @typing.overload
    def to_polynomial(self, modulus: builtins.int, power: typing.Optional[tuple[builtins.int, Expression]] = None, minimal_poly: typing.Optional[Polynomial] = None, vars: typing.Optional[typing.Sequence[Expression]] = None) -> FiniteFieldPolynomial:
        r"""
        Convert the expression to a polynomial, optionally, with the variables and the ordering specified in `vars`.
        All non-polynomial elements will be converted to new independent variables.
    ...
    @typing.overload
    @classmethod
    def symbol(cls, is_symmetric: typing.Optional[builtins.bool] = None, is_antisymmetric: typing.Optional[builtins.bool] = None, is_cyclesymmetric: typing.Optional[builtins.bool] = None, is_linear: typing.Optional[builtins.bool] = None, is_scalar: typing.Optional[builtins.bool] = None, is_real: typing.Optional[builtins.bool] = None, is_integer: typing.Optional[builtins.bool] = None, is_positive: typing.Optional[builtins.bool] = None, tags: typing.Optional[typing.Sequence[builtins.str]] = None, *names: builtins.str) -> typing.Sequence[Expression]:
        r"""
        Create new symbols from `names`. Symbols can have attributes,
        such as symmetries. If no attributes
        are specified and the symbol was previously defined, the attributes are inherited.
    ...
    def get_all_symbol_names(cls) -> builtins.list[builtins.str]:
        ...
        """
    @classmethod
    def parse(cls, input: builtins.str, mode: ParseMode = ..., default_namespace: builtins.str = ...) -> Expression:
        r"""
    ...
    def get_byte_size(self) -> builtins.int:
        ...
        """
    def format(self, mode: PrintMode = ..., terms_on_new_line: builtins.bool = ..., color_top_level_sum: builtins.bool = ..., color_builtin_symbols: builtins.bool = ..., print_ring: builtins.bool = ..., symmetric_representation_for_finite_field: builtins.bool = ..., explicit_rational_polynomial: builtins.bool = ..., number_thousands_separator: typing.Optional[builtins.str] = None, multiplication_operator: builtins.str = ..., double_star_for_exponentiation: builtins.bool = ..., square_brackets_for_function: builtins.bool = ..., num_exp_as_superscript: builtins.bool = ..., precision: typing.Optional[builtins.int] = None, show_namespaces: builtins.bool = ..., include_attributes: builtins.bool = ..., max_terms: typing.Optional[builtins.int] = ..., custom_print_mode: typing.Optional[builtins.int] = None) -> builtins.str:
        r"""
    ...
    def __hash__(self) -> builtins.int:
        ...
        Hash the expression.
        """
    def save(self, filename: builtins.str, compression_level: builtins.int = ...) -> None:
        r"""
    ...
    def is_constant(self) -> builtins.bool:
        ...
        True
        """
    def __add__(self, rhs: Expression | int | str | float | builtins.complex) -> Expression:
        r"""
        Add this expression to `other`, returning the result.
        """
    def __radd__(self, rhs: Expression | int | str | float | builtins.complex) -> Expression:
        r"""
        Add this expression to `other`, returning the result.
        """
    def __sub__(self, rhs: Expression | int | str | float | builtins.complex) -> Expression:
        r"""
        Subtract `other` from this expression, returning the result.
        """
    def __rsub__(self, rhs: Expression | int | str | float | builtins.complex) -> Expression:
        r"""
        Subtract this expression from `other`, returning the result.
        """
    def __mul__(self, rhs: Expression | int | str | float | builtins.complex) -> Expression:
        r"""
        Add this expression to `other`, returning the result.
        """
    def __rmul__(self, rhs: Expression | int | str | float | builtins.complex) -> Expression:
        r"""
        Add this expression to `other`, returning the result.
        """
    def __truediv__(self, rhs: Expression | int | str | float | builtins.complex) -> Expression:
        r"""
        Divide this expression by `other`, returning the result.
        """
    def __rtruediv__(self, rhs: Expression | int | str | float | builtins.complex) -> Expression:
        r"""
        Divide `other` by this expression, returning the result.
        """
    def __pow__(self, exponent: Expression | int | str | float | builtins.complex, modulo: typing.Optional[builtins.int] = None) -> Expression:
        r"""
        Take `self` to power `exp`, returning the result.
        """
    def __rpow__(self, base: Expression | int | str | float | builtins.complex, modulo: typing.Optional[builtins.int] = None) -> Expression:
        r"""
    ...
    def __getitem__(self, idx: builtins.int) -> Expression:
        ...
        """
    def contains(self, s: Expression | int | str | float | builtins.complex | HeldExpression | Transformer) -> Condition:
        r"""
        ...
        """
    def get_all_symbols(self, include_function_symbols: builtins.bool = ...) -> builtins.list[Expression]:
        r"""
        ...
        """
    def get_all_indeterminates(self, enter_functions: builtins.bool = ...) -> builtins.list[Expression]:
        r"""
    ...
    def __richcmp__(self, o: typing.Any, op: int) -> Condition:
        ...
        """
    def req_lt(self, other: Expression | int | str | float | builtins.complex, cmp_any_atom: builtins.bool = ...) -> PatternRestriction:
        r"""
        ...
        """
    def req_gt(self, other: Expression | int | str | float | builtins.complex, cmp_any_atom: builtins.bool = ...) -> PatternRestriction:
        r"""
        ...
        """
    def req_le(self, other: Expression | int | str | float | builtins.complex, cmp_any_atom: builtins.bool = ...) -> PatternRestriction:
        r"""
        ...
        """
    def req_ge(self, other: Expression | int | str | float | builtins.complex, cmp_any_atom: builtins.bool = ...) -> PatternRestriction:
        r"""
    ...
    def req(self, filter_fn: typing.Callable[[Expression], bool | Condition]) -> PatternRestriction:
        ...
        """
    def req_cmp_lt(self, other: Expression, cmp_any_atom: builtins.bool = ...) -> PatternRestriction:
        r"""
        ...
        """
    def req_cmp_gt(self, other: Expression, cmp_any_atom: builtins.bool = ...) -> PatternRestriction:
        r"""
        ...
        """
    def req_cmp_le(self, other: Expression, cmp_any_atom: builtins.bool = ...) -> PatternRestriction:
        r"""
        ...
        """
    def req_cmp_ge(self, other: Expression, cmp_any_atom: builtins.bool = ...) -> PatternRestriction:
        r"""
    ...
    def set_coefficient_ring(self, vars: typing.Sequence[Expression]) -> Expression:
        ...
        vars: List[Expression]
            A list of variables
        """
    def expand(self, var: typing.Optional[Expression | int | str | float | builtins.complex] = None, via_poly: typing.Optional[builtins.bool] = None) -> Expression:
        r"""
    ...
    def expand_num(self) -> Expression:
        ...
        ```
        """
    def collect(self, *x: typing.Any, key_map: typing.Optional[typing.Callable[[Expression], Expression]] = None, coeff_map: typing.Optional[typing.Callable[[Expression], Expression]] = None) -> Expression:
        r"""
    ...
    def collect_num(self) -> Expression:
        ...
        ```
        """
    def coefficient(self, x: Expression | int | str | float | builtins.complex) -> Expression:
        r"""
        ...
        ```
        """
    def coefficient_list(self, *x: typing.Any) -> builtins.list[tuple[Expression, Expression]]:
        r"""
        Collect terms involving the same power of `x`, where `x` is an indeterminate.
        Return the list of key-coefficient pairs and the remainder that matched no key.
        ...
        ```
        """
    def derivative(self, x: Expression | int | str | float | builtins.complex) -> Expression:
        r"""
        Derive the expression w.r.t the variable `x`.
        """
    def series(self, x: Expression | int | str | float | builtins.complex, expansion_point: Expression | int | str | float | builtins.complex, depth: builtins.int, depth_denom: builtins.int = ..., depth_is_absolute: builtins.bool = ...) -> Series:
        r"""
    ...
    def to_rational_polynomial(self, vars: typing.Optional[typing.Sequence[Expression]] = None) -> RationalPolynomial:
        ...
        >>> print(a)
        """
    def match(self, lhs: Expression | int | str | float | builtins.complex, cond: typing.Optional[PatternRestriction | Condition] = None, level_range: typing.Optional[tuple[builtins.int, typing.Optional[builtins.int]]] = None, level_is_tree_depth: typing.Optional[builtins.bool] = None, allow_new_wildcards_on_rhs: typing.Optional[builtins.bool] = None) -> MatchIterator:
        r"""
    ...
    def matches(self, lhs: Expression | int | str | float | builtins.complex, cond: typing.Optional[PatternRestriction | Condition] = None, level_range: typing.Optional[tuple[builtins.int, typing.Optional[builtins.int]]] = None, level_is_tree_depth: typing.Optional[builtins.bool] = None, allow_new_wildcards_on_rhs: typing.Optional[builtins.bool] = None) -> Condition:
        ...
        >>>    print('match')
        """
    def replace_iter(self, lhs: Expression | int | str | float | builtins.complex, rhs: Expression | int | str | float | builtins.complex | HeldExpression | typing.Callable[[dict[Expression, Expression]], Expression] | int | float | complex | decimal.Decimal, cond: typing.Optional[PatternRestriction | Condition] = None, level_range: typing.Optional[tuple[builtins.int, typing.Optional[builtins.int]]] = None, level_is_tree_depth: typing.Optional[builtins.bool] = None, allow_new_wildcards_on_rhs: typing.Optional[builtins.bool] = None) -> ReplaceIterator:
        r"""
    ...
    def replace_wildcards(self, replacements: typing.Mapping[Expression, Expression]) -> Expression:
        ...
        """
    @classmethod
    def solve_linear_system(cls, system: typing.Sequence[Expression | int | str | float | builtins.complex], variables: typing.Sequence[Expression], warn_if_underdetermined: builtins.bool = ...) -> builtins.list[Expression]:
        r"""
        ...
        >>> print('x =', x_r, ', y =', y_r)
        """
    def nsolve(self, variable: Expression, init: builtins.float | decimal.Decimal, prec: builtins.float = ..., max_iterations: builtins.int = ...) -> decimal.Decimal:
        r"""
        ...
        """
    @classmethod
    def nsolve_system(cls, system: typing.Sequence[Expression | int | str | float | builtins.complex], variables: typing.Sequence[Expression], init: typing.Sequence[builtins.float | decimal.Decimal], prec: builtins.float = ..., max_iterations: builtins.int = ...) -> decimal.Decimal:
        r"""
    ...
    def evaluate_with_prec(self, constants: typing.Mapping[Expression, builtins.float | decimal.Decimal], functions: dict[Expression, typing.Callable[[typing.Sequence[decimal.Decimal]], float | str | decimal.Decimal]], decimal_digit_precision: builtins.int) -> decimal.Decimal:
        ...
        """
    def evaluate_complex(self, constants: typing.Mapping[Expression, builtins.complex], functions: dict[Expression, typing.Callable[[typing.Sequence[float | complex]], float | complex]]) -> complex:
        r"""
    ...
    def evaluator_multiple(cls, exprs: typing.Sequence[Expression], constants: typing.Mapping[Expression, Expression], functions: typing.Mapping[tuple[Expression, builtins.str, typing.Sequence[Expression]], Expression], params: typing.Sequence[Expression], iterations: builtins.int = ..., n_cores: builtins.int = ..., verbose: builtins.bool = ..., external_functions: typing.Optional[dict[tuple[Expression, str], typing.Callable[[
        ...
        """
    def canonize_tensors(self, contracted_indices: typing.Sequence[tuple[Expression | int | str | float | builtins.complex, Expression | int | str | float | builtins.complex]]) -> tuple[Expression, builtins.list[tuple[Expression, Expression]], builtins.list[tuple[Expression, Expression]]]:
        r"""
...
class FiniteFieldPolynomial:
    ...
    def __copy__(self) -> FiniteFieldPolynomial:
        ...
        Copy the polynomial.
        """
    def format(self, mode: PrintMode = ..., terms_on_new_line: builtins.bool = ..., color_top_level_sum: builtins.bool = ..., color_builtin_symbols: builtins.bool = ..., print_ring: builtins.bool = ..., symmetric_representation_for_finite_field: builtins.bool = ..., explicit_rational_polynomial: builtins.bool = ..., number_thousands_separator: typing.Optional[builtins.str] = None, multiplication_operator: builtins.str = ..., double_star_for_exponentiation: builtins.bool = ..., square_brackets_for_function: builtins.bool = ..., num_exp_as_superscript: builtins.bool = ..., precision: typing.Optional[builtins.int] = None, show_namespaces: builtins.bool = ..., include_attributes: builtins.bool = ..., max_terms: typing.Optional[builtins.int] = None, custom_print_mode: typing.Optional[builtins.int] = None) -> builtins.str:
        r"""
    ...
    def extended_gcd(self, rhs: FiniteFieldPolynomial) -> tuple[FiniteFieldPolynomial, FiniteFieldPolynomial, FiniteFieldPolynomial]:
        ...
        yields `(1, 3+4*x, 3+x)`.
        """
    def to_integer_polynomial(self, symmetric_representation: builtins.bool = ...) -> Polynomial:
        r"""
    ...
    def replace(self, x: Expression, v: FiniteFieldPolynomial | int) -> FiniteFieldPolynomial:
        ...
        """
    @classmethod
    def groebner_basis(cls, system: typing.Sequence[FiniteFieldPolynomial], grevlex: builtins.bool = ..., print_stats: builtins.bool = ...) -> builtins.list[FiniteFieldPolynomial]:
        r"""
        ...
        """
    def reduce(self, system: typing.Sequence[FiniteFieldPolynomial], grevlex: builtins.bool = ...) -> FiniteFieldPolynomial:
        r"""
    ...
    def integrate(self, x: Expression) -> FiniteFieldPolynomial:
        ...
        """
    @classmethod
    def parse(cls, arg: builtins.str, vars: typing.Sequence[str], prime: builtins.int, default_namespace: builtins.str = ...) -> FiniteFieldPolynomial:
        r"""
    ...
    def to_expression(self) -> Expression:
        ...
        """
    def to_galois_field(self, minimal_poly: FiniteFieldPolynomial) -> GaloisFieldPolynomial:
        r"""
        Convert the polynomial to a Galois field defined by the minimal polynomial `minimal_poly`.
        """
    def adjoin(self, b: FiniteFieldPolynomial, new_symbol: typing.Optional[Expression] = None) -> tuple[FiniteFieldPolynomial, FiniteFieldPolynomial, FiniteFieldPolynomial]:
        r"""
        ...
        """
    def simplify_algebraic_number(self, minimal_poly: FiniteFieldPolynomial) -> FiniteFieldPolynomial:
        r"""
...
class FiniteFieldRationalPolynomial:
    ...
    def apart(self, x: Expression) -> builtins.list[FiniteFieldRationalPolynomial]:
        ...
        """
    @classmethod
    def parse(cls, arg: builtins.str, vars: typing.Sequence[str], prime: builtins.int, default_namespace: builtins.str = ...) -> FiniteFieldRationalPolynomial:
        r"""
...
class GaloisFieldPolynomial:
    ...
    def evaluate(self, values: typing.Sequence[int]) -> int:
        ...
        4
        """
    def replace(self, x: Expression, v: GaloisFieldPolynomial | int) -> GaloisFieldPolynomial:
        r"""
        Replace the variable `x` with a polynomial `v`.
        ...
        """
    @classmethod
    def groebner_basis(cls, system: typing.Sequence[GaloisFieldPolynomial], grevlex: builtins.bool = ..., print_stats: builtins.bool = ...) -> builtins.list[GaloisFieldPolynomial]:
        r"""
        Compute the Groebner basis of a polynomial system.
        ...
        If `print_stats=True` intermediate statistics will be printed.
        """
    def reduce(self, system: typing.Sequence[GaloisFieldPolynomial], grevlex: builtins.bool = ...) -> GaloisFieldPolynomial:
        r"""
        Completely reduce the polynomial w.r.t the polynomials `gs`.
        For example reducing `f=y^2+x` by `g=[x]` yields `y^2`.
        """
...
class GaloisFieldPrimeTwoPolynomial:
    ...
    def get_variables(self) -> builtins.list[Expression]:
        ...
        Get the list of variables in the internal ordering of the polynomial.
        """
    def __add__(self, rhs: GaloisFieldPrimeTwoPolynomial | int) -> GaloisFieldPrimeTwoPolynomial:
        r"""
        Add two polynomials `self and `rhs`, returning the result.
        """
    def __sub__(self, rhs: GaloisFieldPrimeTwoPolynomial | int) -> GaloisFieldPrimeTwoPolynomial:
        r"""
        Subtract polynomials `rhs` from `self`, returning the result.
        """
    def __mul__(self, rhs: GaloisFieldPrimeTwoPolynomial | int) -> GaloisFieldPrimeTwoPolynomial:
        r"""
        Multiply two polynomials `self and `rhs`, returning the result.
        """
    def __radd__(self, rhs: GaloisFieldPrimeTwoPolynomial | int) -> GaloisFieldPrimeTwoPolynomial: ...
    def __rsub__(self, rhs: GaloisFieldPrimeTwoPolynomial | int) -> GaloisFieldPrimeTwoPolynomial: ...
    def __rmul__(self, rhs: GaloisFieldPrimeTwoPolynomial | int) -> GaloisFieldPrimeTwoPolynomial: ...
    def __floordiv__(self, rhs: GaloisFieldPrimeTwoPolynomial) -> GaloisFieldPrimeTwoPolynomial: ...
    ...
    def evaluate(self, values: typing.Sequence[int]) -> int:
        ...
        4
        """
    def replace(self, x: Expression, v: GaloisFieldPrimeTwoPolynomial | int) -> GaloisFieldPrimeTwoPolynomial:
        r"""
        Replace the variable `x` with a polynomial `v`.
        ...
        """
    @classmethod
    def groebner_basis(cls, system: typing.Sequence[GaloisFieldPrimeTwoPolynomial], grevlex: builtins.bool = ..., print_stats: builtins.bool = ...) -> builtins.list[GaloisFieldPrimeTwoPolynomial]:
        r"""
        Compute the Groebner basis of a polynomial system.
        ...
        If `print_stats=True` intermediate statistics will be printed.
        """
    def reduce(self, system: typing.Sequence[GaloisFieldPrimeTwoPolynomial], grevlex: builtins.bool = ...) -> GaloisFieldPrimeTwoPolynomial:
        r"""
        Completely reduce the polynomial w.r.t the polynomials `gs`.
        For example reducing `f=y^2+x` by `g=[x]` yields `y^2`.
        """
...
class Graph:
    ...
    def __richcmp__(self, other: Graph, op: int) -> builtins.bool:
        ...
        """
    @classmethod
    def generate(cls, external_edges: typing.Sequence[tuple[Expression | int | str | float | builtins.complex, HalfEdge]], vertex_signatures: typing.Sequence[typing.Sequence[HalfEdge]], max_vertices: typing.Optional[builtins.int] = None, max_loops: typing.Optional[builtins.int] = None, max_bridges: typing.Optional[builtins.int] = None, allow_self_loops: typing.Optional[builtins.bool] = None, allow_zero_flow_edges: typing.Optional[builtins.bool] = None, filter_fn: typing.Optional[typing.Callable[[Graph, int], bool]] = None, progress_fn: typing.Optional[typing.Callable[[Graph], bool]] = None) -> builtins.dict[Graph, Expression]:
        r"""
    ...
    def to_mermaid(self) -> builtins.str:
        ...
        """
    def add_node(self, data: typing.Optional[Expression | int | str | float | builtins.complex] = None) -> builtins.int:
        r"""
        Add a node with data `data` to the graph, returning the index of the node.
        The default data is the number 0.
        """
    def add_edge(self, source: builtins.int, target: builtins.int, directed: builtins.bool = ..., data: typing.Optional[Expression | int | str | float | builtins.complex] = None) -> builtins.int:
        r"""
...
class HalfEdge:
    ...
    """
    def __new__(cls, data: Expression | int | str | float | builtins.complex, direction: typing.Optional[builtins.bool] = None) -> HalfEdge:
        r"""
...
class HeldExpression:
    ...
    def __call__(self) -> Expression:
        ...
        >>> print(e)
        """
    def __richcmp__(self, other: Expression | int | str | float | builtins.complex | HeldExpression, op: int) -> Condition:
        r"""
        Compare two expressions. If one of the expressions is not a number, an
        internal ordering will be used.
        """
    ...
    def contains(self, s: Expression | int | str | float | builtins.complex | HeldExpression | Transformer) -> Condition:
        ...
        Returns true iff `self` contains `a` literally.
        """
    def matches(self, lhs: Expression | int | str | float | builtins.complex | HeldExpression, cond: typing.Optional[PatternRestriction | Condition] = None, level_range: typing.Optional[tuple[builtins.int, typing.Optional[builtins.int]]] = None, level_is_tree_depth: typing.Optional[builtins.bool] = None, allow_new_wildcards_on_rhs: typing.Optional[builtins.bool] = None) -> Condition:
        r"""
        Create a transformer that tests whether the pattern is found in the expression.
        Restrictions on the pattern can be supplied through `cond`.
        """
    def __add__(self, rhs: Expression | int | str | float | builtins.complex | HeldExpression) -> HeldExpression:
        r"""
        Add this transformer to `other`, returning the result.
        """
    def __radd__(self, rhs: Expression | int | str | float | builtins.complex | HeldExpression) -> HeldExpression:
        r"""
        Add this transformer to `other`, returning the result.
        """
    def __sub__(self, rhs: Expression | int | str | float | builtins.complex | HeldExpression) -> HeldExpression:
        r"""
        Subtract `other` from this transformer, returning the result.
        """
    def __rsub__(self, rhs: Expression | int | str | float | builtins.complex | HeldExpression) -> HeldExpression:
        r"""
        Subtract this transformer from `other`, returning the result.
        """
    def __mul__(self, rhs: Expression | int | str | float | builtins.complex | HeldExpression) -> HeldExpression:
        r"""
        Add this transformer to `other`, returning the result.
        """
    def __rmul__(self, rhs: Expression | int | str | float | builtins.complex | HeldExpression) -> HeldExpression:
        r"""
        Add this transformer to `other`, returning the result.
        """
    def __truediv__(self, rhs: Expression | int | str | float | builtins.complex | HeldExpression) -> HeldExpression:
        r"""
        Divide this transformer by `other`, returning the result.
        """
    def __rtruediv__(self, rhs: Expression | int | str | float | builtins.complex | HeldExpression) -> HeldExpression:
        r"""
        Divide `other` by this transformer, returning the result.
        """
    def __pow__(self, exponent: Expression | int | str | float | builtins.complex | HeldExpression, modulo: typing.Optional[builtins.int] = None) -> HeldExpression:
        r"""
        Take `self` to power `exp`, returning the result.
        """
    def __rpow__(self, base: Expression | int | str | float | builtins.complex | HeldExpression, modulo: typing.Optional[builtins.int] = None) -> HeldExpression:
        r"""
        Take `base` to power `self`, returning the result.
        """
...
class Integer:
    ...
    def lcm(cls, n1: int, n2: int) -> int:
        ...
        """
    @classmethod
    def solve_integer_relation(cls, x: typing.Sequence[builtins.float | decimal.Decimal], tolerance: builtins.float | decimal.Decimal, max_iter: builtins.int = ..., max_coeff: typing.Optional[int] = None, gamma: typing.Optional[builtins.float | decimal.Decimal] = None) -> builtins.list[int]:
        r"""
...
class Matrix:
    ...
    def format(self, mode: PrintMode = ..., pretty_matrix: builtins.bool = ..., number_thousands_separator: typing.Optional[builtins.str] = None, multiplication_operator: builtins.str = ..., double_star_for_exponentiation: builtins.bool = ..., square_brackets_for_function: builtins.bool = ..., num_exp_as_superscript: builtins.bool = ..., precision: typing.Optional[builtins.int] = None, show_namespaces: builtins.bool = ..., include_attributes: builtins.bool = ..., max_terms: typing.Optional[builtins.int] = None, custom_print_mode: typing.Optional[builtins.int] = None) -> builtins.str:
        r"""
...
class NumberFieldPolynomial:
    ...
    def replace(self, x: Expression, v: NumberFieldPolynomial | int) -> NumberFieldPolynomial:
        ...
        """
    @classmethod
    def groebner_basis(cls, system: typing.Sequence[NumberFieldPolynomial], grevlex: builtins.bool = ..., print_stats: builtins.bool = ...) -> builtins.list[NumberFieldPolynomial]:
        r"""
        Compute the Groebner basis of a polynomial system.
        ...
        If `print_stats=True` intermediate statistics will be printed.
        """
    def reduce(self, system: typing.Sequence[NumberFieldPolynomial], grevlex: builtins.bool = ...) -> NumberFieldPolynomial:
        r"""
        Completely reduce the polynomial w.r.t the polynomials `gs`.
        For example reducing `f=y^2+x` by `g=[x]` yields `y^2`.
        """
...
class NumericalIntegrator:
    @classmethod
    def continuous(cls, n_dims: builtins.int, n_bins: builtins.int = ..., min_samples_for_update: builtins.int = ..., bin_number_evolution: typing.Optional[typing.Sequence[builtins.int]] = None, train_on_avg: builtins.bool = ...) -> NumericalIntegrator:
        r"""
        Create a new continuous grid for the numerical integrator.
        """
    @classmethod
    def discrete(cls, bins: typing.Sequence[typing.Optional[NumericalIntegrator]], max_prob_ratio: builtins.float = ..., train_on_avg: builtins.bool = ...) -> NumericalIntegrator:
        r"""
        ...
        """
    @classmethod
    def uniform(cls, bins: typing.Sequence[builtins.int], continuous_grid: NumericalIntegrator) -> NumericalIntegrator:
        r"""
    ...
    def update(self, discrete_learning_rate: builtins.float, continuous_learning_rate: builtins.float) -> tuple[builtins.float, builtins.float, builtins.float]:
        ...
        """
    def integrate(self, integrand: typing.Callable[[typing.Sequence[Sample]], list[float]], max_n_iter: builtins.int = ..., min_error: builtins.float = ..., n_samples_per_iter: builtins.int = ..., seed: builtins.int = ..., show_stats: builtins.bool = ...) -> tuple[builtins.float, builtins.float, builtins.float]:
        r"""
...
class Polynomial:
    ...
    def replace(self, x: Expression, v: Polynomial | int) -> Polynomial:
        ...
        """
    @classmethod
    def parse(cls, arg: builtins.str, vars: typing.Sequence[str], default_namespace: builtins.str = ...) -> Polynomial:
        r"""
    ...
    def to_finite_field(self, prime: builtins.int) -> FiniteFieldPolynomial:
        ...
        """
    @classmethod
    def groebner_basis(cls, system: typing.Sequence[Polynomial], grevlex: builtins.bool = ..., print_stats: builtins.bool = ...) -> builtins.list[Polynomial]:
        r"""
        Compute the Groebner basis of a polynomial system.
        ...
        >>>     print(p)
        """
    def reduce(self, system: typing.Sequence[Polynomial], grevlex: builtins.bool = ...) -> Polynomial:
        r"""
        Completely reduce the polynomial w.r.t the polynomials `gs`.
        For example reducing `f=y^2+x` by `g=[x]` yields `y^2`.
        """
    ...
    def to_expression(self) -> Expression:
        ...
        """
    @classmethod
    def interpolate(cls, x: Expression, sample_points: typing.Sequence[Expression | int | str | float | builtins.complex], values: typing.Sequence[Polynomial]) -> Polynomial:
        r"""
    ...
    def to_number_field(self, minimal_poly: Polynomial) -> NumberFieldPolynomial:
        ...
        Yields `2`.
        """
    def adjoin(self, b: Polynomial, new_symbol: typing.Optional[Expression] = None) -> tuple[Polynomial, Polynomial, Polynomial]:
        r"""
        Adjoin the coefficient ring of this polynomial `R[a]` with `b`, whose minimal polynomial
        is `R[a][b]` and form `R[b]`. Also return the new representation of `a` and `b`.
...
class PrimeTwoPolynomial:
    ...
    def replace(self, x: Expression, v: PrimeTwoPolynomial | int) -> PrimeTwoPolynomial:
        ...
        """
    @classmethod
    def groebner_basis(cls, system: typing.Sequence[PrimeTwoPolynomial], grevlex: builtins.bool = ..., print_stats: builtins.bool = ...) -> builtins.list[PrimeTwoPolynomial]:
        r"""
        Compute the Groebner basis of a polynomial system.
        ...
        If `print_stats=True` intermediate statistics will be printed.
        """
    def reduce(self, system: typing.Sequence[PrimeTwoPolynomial], grevlex: builtins.bool = ...) -> PrimeTwoPolynomial:
        r"""
        Completely reduce the polynomial w.r.t the polynomials `gs`.
        For example reducing `f=y^2+x` by `g=[x]` yields `y^2`.
        """
...
class RationalPolynomial:
    ...
    def denominator(self) -> Polynomial:
        ...
        """
    @classmethod
    def parse(cls, arg: builtins.str, vars: typing.Sequence[str], default_namespace: builtins.str = ...) -> RationalPolynomial:
        r"""
        Parse a rational polynomial from a string.
        The list of all the variables must be provided.
...
class Replacement:
    ...
    def __new__(cls, pattern: Expression | int | str | float | builtins.complex, rhs: Expression | int | str | float | builtins.complex | HeldExpression | typing.Callable[[dict[Expression, Expression]], Expression] | int | float | complex | decimal.Decimal, cond: typing.Optional[PatternRestriction | Condition] = None, non_greedy_wildcards: typing.Optional[typing.Sequence[Expression]] = None, level_range: typing.Optional[tuple[builtins.int, typing.Optional[builtins.int]]] = None, level_is_tree_depth: typing.Optional[builtins.bool] = None, allow_new_wildcards_on_rhs: typing.Optional[builtins.bool] = None, rhs_cache_size: typing.Optional[builtins.int] = None) -> Replacement: ...
...
class Transformer:
    ...
    def __new__(cls) -> Transformer:
        ...
        """
    def __call__(self, expr: Expression | int | str | float | builtins.complex, stats_to_file: typing.Optional[builtins.str] = None) -> Expression:
        r"""
        ...
        stats_to_file: str, optional
            If set, the output of the `stats` transformer will be written to a file in JSON format.
        """
    def __richcmp__(self, other: Expression | int | str | float | builtins.complex | HeldExpression | Transformer, op: int) -> Condition:
        r"""
        Compare two expressions. If one of the expressions is not a number, an
        internal ordering will be used.
        """
    ...
    def contains(self, s: Expression | int | str | float | builtins.complex | HeldExpression | Transformer) -> Condition:
        ...
        Returns true iff `self` contains `a` literally.
        """
    def matches(self, lhs: Expression | int | str | float | builtins.complex | HeldExpression | Transformer, cond: typing.Optional[PatternRestriction | Condition] = None, level_range: typing.Optional[tuple[builtins.int, typing.Optional[builtins.int]]] = None, level_is_tree_depth: typing.Optional[builtins.bool] = None, allow_new_wildcards_on_rhs: typing.Optional[builtins.bool] = None) -> Condition:
        r"""
        Create a transformer that tests whether the pattern is found in the expression.
        Restrictions on the pattern can be supplied through `cond`.
        """
    def expand(self, var: typing.Optional[Expression | int | str | float | builtins.complex] = None, via_poly: typing.Optional[builtins.bool] = None) -> Transformer:
        r"""
    ...
    def split(self) -> Transformer:
        ...
        >>> print(e)
        """
    def partitions(self, bins: typing.Sequence[tuple[Expression | int | str | float | builtins.complex | HeldExpression, builtins.int]], fill_last: builtins.bool = ..., repeat: builtins.bool = ...) -> Transformer:
        r"""
        ...
        """
    def permutations(self, function_name: Expression | int | str | float | builtins.complex | HeldExpression) -> Transformer:
        r"""
    ...
    def map(self, f: typing.Callable[[Expression], Expression | int | float | complex | decimal.Decimal]) -> Transformer:
        ...
        >>> print(e)
        """
    def map_terms(self, *transformers: typing.Any, n_cores: builtins.int = ...) -> Transformer:
        r"""
    ...
    def set_coefficient_ring(self, vars: typing.Sequence[Expression]) -> Transformer:
        ...
        vars: List[Expression]
            A list of variables
        """
    def collect(self, *x: typing.Any, key_map: typing.Optional[Transformer] = None, coeff_map: typing.Optional[Transformer] = None) -> Transformer:
        r"""
    ...
    def conjugate(self) -> Transformer:
        ...
        """
    def coefficient(self, x: Expression | int | str | float | builtins.complex) -> Transformer:
        r"""
    ...
    def factor(self) -> Transformer:
        ...
        """
    def derivative(self, x: Expression | int | str | float | builtins.complex | HeldExpression) -> Transformer:
        r"""
        Create a transformer that derives `self` w.r.t the variable `x`.
        """
    def series(self, x: Expression | int | str | float | builtins.complex, expansion_point: Expression | int | str | float | builtins.complex, depth: builtins.int, depth_denom: builtins.int = ..., depth_is_absolute: builtins.bool = ...) -> Transformer:
        r"""
        ...
        yields `f(0)+x*der(1,f(0))+1/2*x^2*(der(2,f(0))+4*y)`.
        """
    def replace(self, lhs: Expression | int | str | float | builtins.complex, rhs: Expression | int | str | float | builtins.complex | HeldExpression | typing.Callable[[dict[Expression, Expression]], Expression] | int | float | complex | decimal.Decimal, cond: typing.Optional[PatternRestriction | Condition] = None, non_greedy_wildcards: typing.Optional[typing.Sequence[Expression]] = None, level_range: typing.Optional[tuple[builtins.int, typing.Optional[builtins.int]]] = None, level_is_tree_depth: typing.Optional[builtins.bool] = None, allow_new_wildcards_on_rhs: typing.Optional[builtins.bool] = None, rhs_cache_size: typing.Optional[builtins.int] = None) -> Transformer:
        r"""
    ...
    def replace_multiple(self, replacements: typing.Sequence[Replacement]) -> Transformer:
        ...
        """
    def print(self, mode: PrintMode = ..., terms_on_new_line: builtins.bool = ..., color_top_level_sum: builtins.bool = ..., color_builtin_symbols: builtins.bool = ..., print_ring: builtins.bool = ..., symmetric_representation_for_finite_field: builtins.bool = ..., explicit_rational_polynomial: builtins.bool = ..., number_thousands_separator: typing.Optional[builtins.str] = None, multiplication_operator: builtins.str = ..., double_star_for_exponentiation: builtins.bool = ..., square_brackets_for_function: builtins.bool = ..., num_exp_as_superscript: builtins.bool = ..., precision: typing.Optional[builtins.int] = None, show_namespaces: builtins.bool = ..., include_attributes: builtins.bool = ..., max_terms: typing.Optional[builtins.int] = None, custom_print_mode: typing.Optional[builtins.int] = None) -> Transformer:
        r"""
        ...
        """
    def stats(self, tag: builtins.str, transformer: Transformer, color_medium_change_threshold: typing.Optional[builtins.float] = ..., color_large_change_threshold: typing.Optional[builtins.float] = ...) -> Transformer:
        r"""
...
def E(expr: builtins.str, mode: ParseMode = ..., default_namespace: builtins.str = ...) -> Expression:
    r"""
    Parse a Symbolica expression from a string.
...
@typing.overload
def P(poly: builtins.str, modulus: builtins.int, power: typing.Optional[tuple[builtins.int, Expression]] = None, default_namespace: typing.Optional[builtins.str] = None, minimal_poly: typing.Optional[Polynomial] = None, vars: typing.Optional[typing.Sequence[Expression]] = None) -> FiniteFieldPolynomial:
    r"""
...
@typing.overload
def P(poly: builtins.str, minimal_poly: Polynomial, default_namespace: typing.Optional[builtins.str] = None, vars: typing.Optional[typing.Sequence[Expression]] = None) -> NumberFieldPolynomial:
    r"""
    Parse a string to a polynomial, optionally, with the variables and the ordering specified in `vars`.
    All non-polynomial elements will be converted to new independent variables.
...
@typing.overload
def P(poly: builtins.str, default_namespace: typing.Optional[builtins.str] = None, vars: typing.Optional[typing.Sequence[Expression]] = None) -> Polynomial:
    r"""
...
def S(name: builtins.str, is_symmetric: typing.Optional[builtins.bool] = None, is_antisymmetric: typing.Optional[builtins.bool] = None, is_cyclesymmetric: typing.Optional[builtins.bool] = None, is_linear: typing.Optional[builtins.bool] = None, is_scalar: typing.Optional[builtins.bool] = None, is_real: typing.Optional[builtins.bool] = None, is_integer: typing.Optional[builtins.bool] = None, is_positive: typing.Optional[builtins.bool] = None, tags: typing.Optional[typing.Sequence[builtins.str]] = None, custom_normalization: typing.Optional[Transformer] = None, custom_print: typing.Optional[typing.Callable[..., typing.Optional[str]]] = None, custom_derivative: typing.Optional[typing.Callable[[Expression, int], Expression]] = None) -> Expression:
    r"""
    Create new symbols from a `name`. Symbols can have attributes,
    such as symmetries. If no attributes
    are specified and the symbol was previously defined, the attributes are inherited.
    Once attributes are defined on a symbol, they cannot be redefined later.
...
@typing.overload
def S(is_symmetric: typing.Optional[builtins.bool] = None, is_antisymmetric: typing.Optional[builtins.bool] = None, is_cyclesymmetric: typing.Optional[builtins.bool] = None, is_linear: typing.Optional[builtins.bool] = None, is_scalar: typing.Optional[builtins.bool] = None, is_real: typing.Optional[builtins.bool] = None, is_integer: typing.Optional[builtins.bool] = None, is_positive: typing.Optional[builtins.bool] = None, tags: typing.Optional[typing.Sequence[builtins.str]] = None, *names: builtins.str) -> builtins.list[Expression]:
    r"""
    Create new symbols from `names`. Symbols can have attributes,
    such as symmetries. If no attributes
    are specified and the symbol was previously defined, the attributes are inherited.
